 ...
 <div class="content-wrapper">
    ...
    <section class="content">
      <div class="inner-content">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{URL::to('admin/pages/store')}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-11">
                            <input type="text" class="form-control" name="title" id="title" value="{{ old('first_name') }}" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-11">
                            <input type="text" class="form-control" name="slug"  id="slug" value="{{ old('last_name') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-1">
                            ...
                            <a href="{{URL::to('admin/pages')}}" class="btn btn-success cancel">Cancel</a>
                        </div>
                    </div>
                </form>
