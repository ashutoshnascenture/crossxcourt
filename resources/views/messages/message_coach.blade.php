...
@section('content')
	...
	<div class="container">
		...
		<h3 class="contact-title"><?php echo Lang::get('registerCoach.message_coach'); ?>
		{{ucfirst($coach->first_name)}} {{ $coach->last_name }}
		</h3>
		
		<?php 
		$action = LaravelLocalization::localizeURL('customer/login');
		if(Auth::user()){
			$action = LaravelLocalization::localizeURL('message/add');
		}
		...
		<form action="{{LaravelLocalization::localizeURL('send_message')}}" method="POST" class="messageForm">
			...
			<input type="hidden" name="to" value="{{ $coach->id }}">
	...
	<div class="contact-address messages-right-section col-md-4  col-sm-12 col-xs-12 margin-top-bottom-5"> 
      ...
      <div class="panel-group" id="accordion">
       ...
       <div class="panel-heading">
        ...
        <?php echo Lang::get('registerCoach.where_i_can_play'); ?>
        </a>
         </h4>
       </div>
       <div id="collapseOne" class="panel-collapse collapse in">
         <div class="panel-body" style="text-align: justify;">
       <?php echo Lang::get('registerCoach.where_i_can_play_text'); ?>
         </div>
       </div>
        </div>
       <div class="panel panel-default">
       <div class="panel-heading">
        ...
        <?php echo Lang::get('registerCoach.what_if_rains'); ?>
        </a>
         </h4>
       </div>
       <div id="collapseTwo" class="panel-collapse collapse">
         <div class="panel-body" style="text-align: justify;">
         <?php echo Lang::get('registerCoach.what_if_rains_text'); ?>
         </div>
       </div>
        </div>
       <div class="panel panel-default">
       ...
       <?php echo Lang::get('registerCoach.how_can_i_cancel'); ?>
        </a>
         </h4>
       </div>
       <div id="collapseThree" class="panel-collapse collapse">
         <div class="panel-body" style="text-align: justify;">
        <?php echo Lang::get('registerCoach.how_can_i_cancel_text'); ?>
         </div>
       </div>
        </div>
      </div>
...
<!--
   <p><?php //echo Lang::get('registerCoach.ask_question'); ?></p>
   <p><?php //echo Lang::get('registerCoach.need_help'); ?></p>
-->
    ...
    <br>
     <p><a href="mailto:{{ Config::get('constants.SITE_EMAIL') }}"><i class="fa fa-envelope envelp" aria-hidden="true"></i><?php echo Lang::get('registerCoach.send_message'); ?></a></p>
