...
@section('content')
	...
	<section class="apply-coaches padding-top-bottom-5 work-search">
		<div class="container">
		<form class="form-inline search-form" action="find-services" method="post">
			<input type="hidden" name="_token" value="{{csrf_token()}}">
			<div class="form-group postal postal-1">
				<input type="text" class="form-control" id="postal" name="zip_code" placeholder="Postal code, City or Town" required>
			</div>
			...
			<button type="submit" class="btn btn-success search-coach">Search Coaches</button>
		</form>
		</div>
    </section> 
