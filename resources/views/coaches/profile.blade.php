...
<section class="my-tabs-section" id="section-tabs">
	...
	<div class="alert alert-danger">
		<strong>Whoops!</strong> <?php echo Lang::get('coachProfile.alert_msg'); ?><br><br>
		<ul>
			...
			<div class="row">
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 tabs-left-content">
					...
					<ul class="list-group tabs-listing-sec">
						...
						<li><span class="left-1"><?php echo Lang::get('coachProfile.experience'); ?></span><span class="right-1">{{$coach->Info['tennis_experience']}}&nbsp;<?php echo Lang::get('coachProfile.years_experience'); ?></span></li>
					...
					<aside class="about-section">
						...
						<div class="que-box">
							...
							<p class="que"><?php echo Lang::get('coachProfile.Where_can_you_play'); ?></p>
...
<!--
									<option selected="selected" value=""></option>
-->
									<option value="Morning"><?php echo Lang::get('coachProfile.morning'); ?> (7am-12pm)</option>
									<option value="Afternoon"><?php echo Lang::get('coachProfile.afternoon'); ?> (12pm-5pm)</option>
									<option value="Evening"><?php echo Lang::get('coachProfile.evening'); ?> (5pm-10pm)</option>
									<option value="Flexible"><?php echo Lang::get('coachProfile.flexible'); ?></option>
								</select>
							</div>
							<div class="form-group">
								...
								<select class="form-control box-select" id="lesson_location" name="lesson_location"  >	 
									...
									<option selected="selected" value="0"><?php echo Lang::get('coachProfile.please_select'); ?></option>
							...
							<div class="form-group" >
								<label for="lesson_location_id" id="text1" style="display:none;"><?php echo Lang::get('coachProfile.court_name'); ?></label>
								<label for="lesson_location_id" id="text2" style="display:none;"><?php echo Lang::get('coachProfile.what_city'); ?></label>
								<input type="text" name="lesson_location_description" id="lesson_location_id" class="form-control"  style="display:none;" />
							</div>
